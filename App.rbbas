...
Inherits Application
	#tag Event
		Sub Close()
		  For i As Integer = SpecialFolder.Temporary.Child("Simple Paint").Count DownTo 1
		    SpecialFolder.Temporary.Child("Simple Paint").Item(i).Delete
		  Next
		  SpecialFolder.Temporary.Child("Simple Paint").Delete
		End Sub
	#tag EndEvent
