...
Protected Module GlobalHelpers
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  return mHelpSelectMode
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  mHelpSelectMode = value
			  If MainWindow.placardButton1.value <> value Then
			    MainWindow.placardButton1.value = value
			  End If
			End Set
		#tag EndSetter
		HelpSelectMode As Boolean
	#tag EndComputedProperty
